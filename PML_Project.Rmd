...
## Generate files for test cases for quiz submission
Create a function to generate files with predictions 
```{r}
...
```
Call above function to generate files
```{r}
write_prediction(predRF_Test)
```
